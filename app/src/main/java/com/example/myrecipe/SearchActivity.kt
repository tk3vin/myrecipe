...
class SearchActivity : AppCompatActivity() {
    ...
    private fun searchRecipes() {
        var url = "https://api.edamam.com/search?q=${searchWord}&app_id=897706d4&app_key=d8c4cfe409f685c58f55e07c4cd41e1c\t&&from=${min}&to=${max}&calories=591-722&health=alcohol-free"
